...
/// </summary>
[System.ComponentModel.DataAnnotations.Schema.Table("Location", Schema = "Production")]
    ...
    : HasDomainEventsBase, IIdentity<short>
{
    ...
    /// </value>
    [System.ComponentModel.DataAnnotations.Schema.Column("CostRate", TypeName = "smallmoney")]
    ...
    /// </value>
    [System.ComponentModel.DataAnnotations.Schema.Column("Availability", TypeName = "decimal(8,2)")]
