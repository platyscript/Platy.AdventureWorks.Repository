...
/// </summary>
[System.ComponentModel.DataAnnotations.Schema.Table("ShipMethod", Schema = "Purchasing")]
    ...
    : HasDomainEventsBase, IIdentity<int>
{
    ...
    /// </value>
    [System.ComponentModel.DataAnnotations.Schema.Column("ShipBase", TypeName = "money")]
    ...
    /// </value>
    [System.ComponentModel.DataAnnotations.Schema.Column("ShipRate", TypeName = "money")]
