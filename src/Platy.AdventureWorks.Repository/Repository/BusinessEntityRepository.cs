...
public class BusinessEntityRepository
    : EntityRepository<BusinessEntity,int, BusinessEntityReadModel, BusinessEntityCreateModel, BusinessEntityUpdateModel>, IBusinessEntityRepository
{
    /// <summary>
    ...
    public async Task<Result<IReadOnlyList<BusinessEntityReadModel>>> ListAsync(
       ...
       CancellationToken cancellationToken) =>
       await QueryModel<BusinessEntity,int>(predicate, cancellationToken);
