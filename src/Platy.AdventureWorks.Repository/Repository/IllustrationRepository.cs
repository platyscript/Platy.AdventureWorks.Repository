...
public class IllustrationRepository
    : EntityRepository<Illustration,int, IllustrationReadModel, IllustrationCreateModel, IllustrationUpdateModel>, IIllustrationRepository
{
    /// <summary>
    ...
    public async Task<Result<IReadOnlyList<IllustrationReadModel>>> ListAsync(
       ...
       CancellationToken cancellationToken) =>
       await QueryModel<Illustration,int>(predicate, cancellationToken);
