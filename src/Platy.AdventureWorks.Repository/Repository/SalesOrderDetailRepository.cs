...
public class SalesOrderDetailRepository
    : EntityRepository<SalesOrderDetail,int, SalesOrderDetailReadModel, SalesOrderDetailCreateModel, SalesOrderDetailUpdateModel>, ISalesOrderDetailRepository
{
    /// <summary>
    ...
    public async Task<Result<IReadOnlyList<SalesOrderDetailReadModel>>> ListAsync(
       ...
       CancellationToken cancellationToken) =>
       await QueryModel<SalesOrderDetail,int>(predicate, cancellationToken);
...
public interface ISalesOrderDetailRepository
    : IRepository<SalesOrderDetail,int, SalesOrderDetailReadModel, SalesOrderDetailCreateModel, SalesOrderDetailUpdateModel>
{
}
