...
public class SalesOrderHeaderRepository
    : EntityRepository<SalesOrderHeader,int, SalesOrderHeaderReadModel, SalesOrderHeaderCreateModel, SalesOrderHeaderUpdateModel>, ISalesOrderHeaderRepository
{
    /// <summary>
    ...
    public async Task<Result<IReadOnlyList<SalesOrderHeaderReadModel>>> ListAsync(
       ...
       CancellationToken cancellationToken) =>
       await QueryModel<SalesOrderHeader,int>(predicate, cancellationToken);
...
public interface ISalesOrderHeaderRepository
    : IRepository<SalesOrderHeader,int, SalesOrderHeaderReadModel, SalesOrderHeaderCreateModel, SalesOrderHeaderUpdateModel>
{
}
