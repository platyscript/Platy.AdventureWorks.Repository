...
public class SalesReasonRepository
    : EntityRepository<SalesReason,int, SalesReasonReadModel, SalesReasonCreateModel, SalesReasonUpdateModel>, ISalesReasonRepository
{
    /// <summary>
    ...
    public async Task<Result<IReadOnlyList<SalesReasonReadModel>>> ListAsync(
       ...
       CancellationToken cancellationToken) =>
       await QueryModel<SalesReason,int>(predicate, cancellationToken);
