...
public class StateProvinceRepository
    : EntityRepository<StateProvince,int, StateProvinceReadModel, StateProvinceCreateModel, StateProvinceUpdateModel>, IStateProvinceRepository
{
    /// <summary>
    ...
    public async Task<Result<IReadOnlyList<StateProvinceReadModel>>> ListAsync(
       ...
       CancellationToken cancellationToken) =>
       await QueryModel<StateProvince,int>(predicate, cancellationToken);
